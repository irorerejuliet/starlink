    ...
    <section className="bg-black py-20  md:px-0 px bg-residentialEarth3 bg-fixed bg-center bg-[auto_950px] bg-no-repeat">
        ...
        <Slider {...settings}>
          {Accessories.map(({ image, title, id }) => (
            <div className="text-center px-4" key={id}>
              <img src={image} alt="ETHERNET ROUTER" />
      ...
      <div className="text-white mt-80 w-[1419px] mx-auto md:px-0 px-5 ">
        ...
        <div className="md:flex justify-between items-center gap-20">
          ...
          <div className="space-y-5 border-l-4 pl-12">
